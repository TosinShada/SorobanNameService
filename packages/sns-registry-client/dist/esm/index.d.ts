...
export declare const networks: {
    readonly futurenet: {
        ...
        readonly contractId: "CAAZHBIXVON4YGJKIHY7TETMZ5FQWAX5GXKUQSERPBZG7XFD3YMJPQJJ";
    };
};
export type DataKey = {
    tag: "Records";
...
export declare class Contract {
    ...
    initialize<R extends ResponseTypes = undefined>({ admin, resolver }: {
        admin: Address;
        resolver: Address;
    }, options?: {
        /**
    ...
    setRecord<R extends ResponseTypes = undefined>({ caller, node, owner, resolver, ttl }: {
        caller: Address;
        node: Buffer;
        owner: Address;
        resolver: Address;
    ...
    setOwner<R extends ResponseTypes = undefined>({ caller, node, owner }: {
        caller: Address;
        node: Buffer;
        owner: Address;
    }, options?: {
    ...
    setSubnodeOwner<R extends ResponseTypes = undefined>({ caller, node, label, owner, resolver, ttl }: {
        caller: Address;
        node: Buffer;
        label: Buffer;
        owner: Address;
    ...
    setResolver<R extends ResponseTypes = undefined>({ caller, node, resolver }: {
        caller: Address;
        node: Buffer;
        resolver: Address;
    }, options?: {
    ...
    setTtl<R extends ResponseTypes = undefined>({ caller, node, ttl }: {
        caller: Address;
        node: Buffer;
        ttl: u64;
    }, options?: {
    ...
    bumpSubnode<R extends ResponseTypes = undefined>({ caller, node, label }: {
        caller: Address;
        node: Buffer;
        label: Buffer;
    }, options?: {
    ...
    setApprovalForAll<R extends ResponseTypes = undefined>({ caller, operator, approved }: {
        caller: Address;
        operator: Address;
        approved: boolean;
    }, options?: {
    ...
    owner<R extends ResponseTypes = undefined>({ node }: {
        node: Buffer;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
    ...
    resolver<R extends ResponseTypes = undefined>({ node }: {
        node: Buffer;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
    ...
    ttl<R extends ResponseTypes = undefined>({ node }: {
        node: Buffer;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
    ...
    record<R extends ResponseTypes = undefined>({ node }: {
        node: Buffer;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
    ...
    recordExist<R extends ResponseTypes = undefined>({ node }: {
        node: Buffer;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: 100.
    ...
    isApprovedForAll<R extends ResponseTypes = undefined>({ operator, owner }: {
        operator: Address;
        owner: Address;
    }, options?: {
        /**
